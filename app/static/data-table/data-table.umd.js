...
// UNUSED EXPORTS: PaginationBare, TableBare
...
function reactivity_esm_bundler_trigger(target, type, key, newValue, oldValue, oldTarget) {
  ...
  for (const dep of deps) {
    if (dep) {
      triggerEffects(dep, 3,  false ? 0 : void 0);
    }
  }
  resetScheduling();
}
...
class ComputedRefImpl {
  constructor(getter, _setter, isReadonly, isSSR) {
    ...
    this.effect = new reactivity_esm_bundler_ReactiveEffect(() => getter(this._value), () => triggerRefValue(this, 1));
  ...
  get value() {
    ...
    if (!self._cacheable || self.effect.dirty) {
      if (shared_esm_bundler_hasChanged(self._value, self._value = self.effect.run())) {
...
function trackRefValue(ref2) {
  if (shouldTrack && activeEffect) {
    ...
    trackEffect(activeEffect, ref2.dep || (ref2.dep = createDep(() => ref2.dep = void 0, ref2 instanceof ComputedRefImpl ? ref2 : void 0)),  false ? 0 : void 0);
  }
}
...
function triggerRef(ref2) {
  triggerRefValue(ref2, 3,  false ? 0 : void 0);
}
function unref(ref2) {
...
const devtools =  false ? 0 : void 0;
const setDevtoolsHook = (/* unused pure expression or super */ null && ( false ? 0 : NOOP));
const _ssrUtils = {
...
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-82.use[1]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/components/dataTable.vue?vue&type=template&id=1c9a9580&scoped=true

const _withScopeId = n => (pushScopeId("data-v-1c9a9580"), n = n(), popScopeId(), n);
const _hoisted_1 = /*#__PURE__*/_withScopeId(() => /*#__PURE__*/createBaseVNode("div", {
  class: "alert alert-warning alert-dismissible fade show",
  role: "alert"
}, [/*#__PURE__*/createBaseVNode("strong", null, "Here"), /*#__PURE__*/createTextVNode(" datatables will rise. "), /*#__PURE__*/createBaseVNode("button", {
  type: "button",
  class: "btn-close",
...
const _hoisted_5 = /*#__PURE__*/_withScopeId(() => /*#__PURE__*/createBaseVNode("button", {
...
const _hoisted_9 = /*#__PURE__*/_withScopeId(() => /*#__PURE__*/createBaseVNode("i", {
  class: "fa fa-plus"
}, null, -1));
const _hoisted_10 = {
...
const _hoisted_16 = /*#__PURE__*/_withScopeId(() => /*#__PURE__*/createBaseVNode("i", {
  class: "fa fa-trash"
}, null, -1));
...
const _hoisted_19 = /*#__PURE__*/_withScopeId(() => /*#__PURE__*/createBaseVNode("div", {
  class: "col-sm-5 my-2"
}, null, -1));
const _hoisted_20 = {
...
function dataTablevue_type_template_id_1c9a9580_scoped_true_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_pagination_bare = resolveComponent("pagination-bare");
  return openBlock(), createElementBlock("div", null, [_hoisted_1, $setup.editing ? (openBlock(), createElementBlock("div", _hoisted_2, [createBaseVNode("h2", null, [$setup.adding ? (openBlock(), createElementBlock("div", _hoisted_3, "Add user")) : (openBlock(), createElementBlock("div", _hoisted_4, "Edit user \"form.username\""))]), createBaseVNode("form", {
    onSubmit: _cache[1] || (_cache[1] = withModifiers((...args) => $setup.onSubmitForm && $setup.onSubmitForm(...args), ["prevent"]))
  }, [renderSlot(_ctx.$slots, "editForm", {}, undefined, true), _hoisted_5, createBaseVNode("button", {
    onClick: _cache[0] || (_cache[0] = withModifiers($event => $setup.editing = $setup.adding = false, ["prevent"])),
    class: "btn btn-secondary",
    type: "button"
  }, "Cancel")], 32)])) : createCommentVNode("", true), !$setup.editing ? (openBlock(), createElementBlock("div", _hoisted_6, [createBaseVNode("h2", null, toDisplayString($setup.capitalize($setup.title)), 1), $setup.totalRows > 0 ? (openBlock(), createElementBlock("div", _hoisted_7, [createBaseVNode("div", _hoisted_8, [createBaseVNode("button", {
    onClick: _cache[2] || (_cache[2] = $event => $setup.editing = $setup.adding = true),
    class: "btn btn-primary"
  }, [_hoisted_9, createBaseVNode("span", _hoisted_10, " Add " + toDisplayString($setup.capitalize($setup.title_s)), 1)]), !$setup.selected.length ? (openBlock(), createElementBlock("small", _hoisted_11, " Click a row to edit or delete. ")) : (openBlock(), createElementBlock("span", _hoisted_12, [createBaseVNode("button", {
    onClick: _cache[3] || (_cache[3] = $event => $setup.editing = true),
    class: "btn btn-secondary ms-1"
  }, _hoisted_15), createBaseVNode("button", {
    onClick: _cache[4] || (_cache[4] = (...args) => $setup.showMsgBoxConfirm && $setup.showMsgBoxConfirm(...args)),
    class: "btn btn-secondary ms-1"
  }, _hoisted_18)]))]), _hoisted_19])) : createCommentVNode("", true), createBaseVNode("table", _hoisted_20, [createBaseVNode("thead", null, [createBaseVNode("tr", null, [(openBlock(true), createElementBlock(runtime_core_esm_bundler_Fragment, null, renderList($setup.fields, (fld, index) => {
    return openBlock(), createElementBlock("th", {
      key: index,
      onClick: $event => _ctx.onHeaderClick(fld)
    }, [typeof fld === 'string' ? (openBlock(), createElementBlock("span", _hoisted_22, toDisplayString(fld), 1)) : (openBlock(), createElementBlock("span", _hoisted_23, [createTextVNode(toDisplayString(fld.key) + " ", 1), ['true', true].includes(fld.sortable) ? (openBlock(), createElementBlock("i", {
      key: 0,
      class: shared_esm_bundler_normalizeClass(["fas", {
        'fa-sort sort-off': $setup.sortBy != fld.key,
        'fa-sort-down': $setup.sortBy == fld.key && !$setup.sortDesc,
        'fa-sort-up': $setup.sortBy == fld.key && $setup.sortDesc
      }])
    }, null, 2)) : createCommentVNode("", true)])), (typeof fld === 'string' ? $setup.sortBy == fld : $setup.sortBy == fld.key) ? (openBlock(), createElementBlock("span", {
      key: 2,
      class: "badge text-bg-light sort-badge",
      onClick: _cache[5] || (_cache[5] = withModifiers((...args) => _ctx.onClickSortBadge && _ctx.onClickSortBadge(...args), ["stop"]))
    }, "x")) : createCommentVNode("", true)], 8, _hoisted_21);
  }), 128))])]), createBaseVNode("tbody", null, [(openBlock(true), createElementBlock(runtime_core_esm_bundler_Fragment, null, renderList($setup.items, (v1, k1) => {
    return openBlock(), createElementBlock("tr", {
      key: k1,
      class: shared_esm_bundler_normalizeClass({
        'table-active': v1.selected
      }),
      onClick: $event => $setup.onRowClick(v1, k1)
    }, [(openBlock(true), createElementBlock(runtime_core_esm_bundler_Fragment, null, renderList(v1, (v2, k2) => {
      return openBlock(), createElementBlock("td", {
        key: k2
      }, [$setup.fields_simple.includes(k2) ? (openBlock(), createElementBlock(runtime_core_esm_bundler_Fragment, {
        key: 0
      }, [createTextVNode(toDisplayString(v2), 1)], 64)) : createCommentVNode("", true)]);
    }), 128))], 10, _hoisted_24);
  }), 128))])]), $setup.totalRows > 0 ? (openBlock(), createElementBlock("div", _hoisted_25, [createBaseVNode("div", _hoisted_26, [withDirectives(createBaseVNode("select", {
    "onUpdate:modelValue": _cache[6] || (_cache[6] = $event => $setup.perPage = $event),
    class: "form-select",
    id: "perPageOptions"
  }, [(openBlock(true), createElementBlock(runtime_core_esm_bundler_Fragment, null, renderList($setup.perPageOptions, (opt, idx) => {
    return openBlock(), createElementBlock("option", {
      key: idx,
      value: opt.value
    }, toDisplayString(opt.label), 9, _hoisted_27);
  }), 128))], 512), [[vModelSelect, $setup.perPage]])]), createBaseVNode("div", _hoisted_28, [runtime_core_esm_bundler_createVNode(_component_pagination_bare, {
    "current-page": $setup.currentPage,
    "total-rows": $setup.totalRows,
    "per-page": $setup.perPage,
    onPageChanged: $setup.pageChanged
  }, null, 8, ["current-page", "total-rows", "per-page", "onPageChanged"])])])) : createCommentVNode("", true)])) : createCommentVNode("", true), createTextVNode(" " + toDisplayString($setup.selected) + " " + toDisplayString($setup.selected.length), 1)]);
}
;// CONCATENATED MODULE: ./src/components/dataTable.vue?vue&type=template&id=1c9a9580&scoped=true

;// CONCATENATED MODULE: ./src/components/dataTable.js

function useDataTable() {
  const flashMessage = reactivity_esm_bundler_ref('Here data-table will rise.');
  const flashMessageVariant = reactivity_esm_bundler_ref('warning');
  var adding = reactivity_esm_bundler_ref(false);
  var editing = reactivity_esm_bundler_ref(false);
  var title = reactivity_esm_bundler_ref('user|users');
  var title_s;
  var items = reactivity_esm_bundler_ref([]);
  var fields = reactivity_esm_bundler_ref([]);
  var currentPage = reactivity_esm_bundler_ref(1);
  var perPage = reactivity_esm_bundler_ref(null);
  var totalRows;
  var perPageOptions = reactivity_esm_bundler_ref([3, 5, 10, 20, 30, 50, 100]);
  var selected = reactivity_esm_bundler_ref([]);
  var sortBy = reactivity_esm_bundler_ref(''),
    sortDesc = reactivity_esm_bundler_ref(false);
  var filter;
  items.value = [{
    id: 1,
    'name': 'John',
  ...
  perPageOptions.value = optionN.value.map(n => ({
    value: n,
    label: `${n} items`
  }));
...
;// CONCATENATED MODULE: ./src/composables/stringUtils.js

function useCapitalize(data) {
  var capitalized = [];
...
function useTable(ctx, fields, sortBy, sortDesc) {
...
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-82.use[1]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/components/tableBare.vue?vue&type=template&id=0b2e150a&scoped=true

const tableBarevue_type_template_id_0b2e150a_scoped_true_withScopeId = n => (_pushScopeId("data-v-0b2e150a"), n = n(), _popScopeId(), n);
const tableBarevue_type_template_id_0b2e150a_scoped_true_hoisted_1 = {
  class: "table table-hover"
};
const tableBarevue_type_template_id_0b2e150a_scoped_true_hoisted_2 = ["onClick"];
const tableBarevue_type_template_id_0b2e150a_scoped_true_hoisted_3 = {
  key: 0
};
const tableBarevue_type_template_id_0b2e150a_scoped_true_hoisted_4 = {
  key: 1
};
const tableBarevue_type_template_id_0b2e150a_scoped_true_hoisted_5 = ["onClick"];
function tableBarevue_type_template_id_0b2e150a_scoped_true_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("table", tableBarevue_type_template_id_0b2e150a_scoped_true_hoisted_1, [createBaseVNode("thead", null, [createBaseVNode("tr", null, [(openBlock(true), createElementBlock(runtime_core_esm_bundler_Fragment, null, renderList($props.fields, (fld, index) => {
    return openBlock(), createElementBlock("th", {
      key: index,
      onClick: $event => $setup.onHeaderClick(fld)
    }, [typeof fld === 'string' ? (openBlock(), createElementBlock("span", tableBarevue_type_template_id_0b2e150a_scoped_true_hoisted_3, toDisplayString(fld), 1)) : (openBlock(), createElementBlock("span", tableBarevue_type_template_id_0b2e150a_scoped_true_hoisted_4, [createTextVNode(toDisplayString(fld.key) + " ", 1), ['true', true].includes(fld.sortable) ? (openBlock(), createElementBlock("i", {
      key: 0,
      class: shared_esm_bundler_normalizeClass(["fas", {
        'fa-sort sort-off': $props.sortBy != fld.key,
        'fa-sort-down': $props.sortBy == fld.key && !$props.sortDesc,
        'fa-sort-up': $props.sortBy == fld.key && $props.sortDesc
      }])
    }, null, 2)) : createCommentVNode("", true)])), (typeof fld === 'string' ? $props.sortBy == fld : $props.sortBy == fld.key) ? (openBlock(), createElementBlock("span", {
      key: 2,
      class: "badge text-bg-light sort-badge",
      onClick: _cache[0] || (_cache[0] = withModifiers((...args) => $setup.onClickSortBadge && $setup.onClickSortBadge(...args), ["stop"]))
    }, "x")) : createCommentVNode("", true)], 8, tableBarevue_type_template_id_0b2e150a_scoped_true_hoisted_2);
  }), 128))])]), createBaseVNode("tbody", null, [(openBlock(true), createElementBlock(runtime_core_esm_bundler_Fragment, null, renderList($props.items, (v1, k1) => {
    return openBlock(), createElementBlock("tr", {
      key: k1,
      class: shared_esm_bundler_normalizeClass({
        'table-active': v1.selected
    ...
    }), 128))], 10, tableBarevue_type_template_id_0b2e150a_scoped_true_hoisted_5);
  }), 128))])]);
}
;// CONCATENATED MODULE: ./src/components/tableBare.vue?vue&type=template&id=0b2e150a&scoped=true

;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-82.use[1]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/components/tableBare.vue?vue&type=script&lang=js
/* harmony default export */ var tableBarevue_type_script_lang_js = ({
  name: 'table-bare',
...
;// CONCATENATED MODULE: ./src/components/tableBare.vue?vue&type=script&lang=js
 
;// CONCATENATED MODULE: ./node_modules/mini-css-extract-plugin/dist/loader.js??clonedRuleSet-54.use[0]!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-54.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-54.use[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/components/tableBare.vue?vue&type=style&index=0&id=0b2e150a&scoped=true&lang=css
// extracted by mini-css-extract-plugin

;// CONCATENATED MODULE: ./src/components/tableBare.vue?vue&type=style&index=0&id=0b2e150a&scoped=true&lang=css

// EXTERNAL MODULE: ./node_modules/vue-loader/dist/exportHelper.js
var exportHelper = __webpack_require__(1620);
;// CONCATENATED MODULE: ./src/components/tableBare.vue
...
const __exports__ = /*#__PURE__*/(0,exportHelper/* default */.Z)(tableBarevue_type_script_lang_js, [['render',tableBarevue_type_template_id_0b2e150a_scoped_true_render],['__scopeId',"data-v-0b2e150a"]])

/* harmony default export */ var tableBare = ((/* unused pure expression or super */ null && (__exports__)));
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-82.use[1]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/components/paginationBare.vue?vue&type=template&id=cac5fd76&scoped=true

const paginationBarevue_type_template_id_cac5fd76_scoped_true_withScopeId = n => (_pushScopeId("data-v-cac5fd76"), n = n(), _popScopeId(), n);
const paginationBarevue_type_template_id_cac5fd76_scoped_true_hoisted_1 = {
  class: "pagination"
};
const paginationBarevue_type_template_id_cac5fd76_scoped_true_hoisted_2 = ["onClick"];
function paginationBarevue_type_template_id_cac5fd76_scoped_true_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("ul", paginationBarevue_type_template_id_cac5fd76_scoped_true_hoisted_1, [createBaseVNode("li", {
    class: shared_esm_bundler_normalizeClass(["page-item-clickable", {
      disabled: $props.currentPage == 1
    }])
  }, [createBaseVNode("a", {
    class: "page-link",
    onClick: _cache[0] || (_cache[0] = $event => $setup.onPagerClick('prev'))
  }, "«")], 2), (openBlock(true), createElementBlock(runtime_core_esm_bundler_Fragment, null, renderList($setup.pageLinks, (item, idx) => {
    return openBlock(), createElementBlock("li", {
      ...
      class: "page-link",
      onClick: $event => $setup.onPagerClick(item)
    }, toDisplayString(item), 9, paginationBarevue_type_template_id_cac5fd76_scoped_true_hoisted_2)], 2);
  }), 128)), createBaseVNode("li", {
    class: shared_esm_bundler_normalizeClass(["page-item-clickable", {
      disabled: $props.currentPage == $setup.lastPage
    }])
  }, [createBaseVNode("a", {
    class: "page-link",
    onClick: _cache[1] || (_cache[1] = $event => $setup.onPagerClick('next'))
  }, "»")], 2)]);
}
;// CONCATENATED MODULE: ./src/components/paginationBare.vue?vue&type=template&id=cac5fd76&scoped=true

;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-82.use[1]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/components/paginationBare.vue?vue&type=script&lang=js

/* harmony default export */ var paginationBarevue_type_script_lang_js = ({
  name: 'pagination-bare',
  props: ['currentPage', 'totalRows', 'perPage'],
  setup(props, ctx) {
    const lastPage = Math.ceil(props.totalRows / parseInt(props.perPage));
    var pageLinks = reactivity_esm_bundler_ref([]);
...
;// CONCATENATED MODULE: ./src/components/paginationBare.vue?vue&type=script&lang=js
 
;// CONCATENATED MODULE: ./node_modules/mini-css-extract-plugin/dist/loader.js??clonedRuleSet-54.use[0]!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-54.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-54.use[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/components/paginationBare.vue?vue&type=style&index=0&id=cac5fd76&scoped=true&lang=css
// extracted by mini-css-extract-plugin

;// CONCATENATED MODULE: ./src/components/paginationBare.vue?vue&type=style&index=0&id=cac5fd76&scoped=true&lang=css

;// CONCATENATED MODULE: ./src/components/paginationBare.vue
...
const paginationBare_exports_ = /*#__PURE__*/(0,exportHelper/* default */.Z)(paginationBarevue_type_script_lang_js, [['render',paginationBarevue_type_template_id_cac5fd76_scoped_true_render],['__scopeId',"data-v-cac5fd76"]])

/* harmony default export */ var paginationBare = (paginationBare_exports_);
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-82.use[1]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/components/dataTable.vue?vue&type=script&lang=js
...
/* harmony default export */ var dataTablevue_type_script_lang_js = ({
  ...
  setup(props, ctx) {
    ...
    const {
      fields_simple
    } = useTable(ctx, fields, sortBy, sortDesc);
...
;// CONCATENATED MODULE: ./node_modules/mini-css-extract-plugin/dist/loader.js??clonedRuleSet-54.use[0]!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-54.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-54.use[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/components/dataTable.vue?vue&type=style&index=0&id=1c9a9580&scoped=true&lang=css
// extracted by mini-css-extract-plugin

;// CONCATENATED MODULE: ./src/components/dataTable.vue?vue&type=style&index=0&id=1c9a9580&scoped=true&lang=css
...
const dataTable_exports_ = /*#__PURE__*/(0,exportHelper/* default */.Z)(dataTablevue_type_script_lang_js, [['render',dataTablevue_type_template_id_1c9a9580_scoped_true_render],['__scopeId',"data-v-1c9a9580"]])

/* harmony default export */ var dataTable = (dataTable_exports_);
;// CONCATENATED MODULE: ./node_modules/@vue/cli-service/lib/commands/build/entry-lib.js


/* harmony default export */ var entry_lib = (dataTable);
